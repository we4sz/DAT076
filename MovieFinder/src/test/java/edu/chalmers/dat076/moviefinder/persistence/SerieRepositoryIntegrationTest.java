...
public class SerieRepositoryIntegrationTest extends AbstractIntegrationTest {
    ...
    public void createSeries() {
        ...
        /*Series saved = repository.findBySID("SeriesTest2id");
        assertEquals("SeriesTest2", saved.getSeriesName());
        
        Pageable pageable = new PageRequest(0, 1);
        Page<Series> page = repository.findBySeriesNameContaining("SeriesTest", pageable);
        assertEquals("SeriesTest2", page.getContent().get(0).getSeriesName());*/
    }
    ...
    public void findBySID() {
        Series e = repository.findBySID("testSeriesID");
        assertThat(e.getSeriesName(), is("testSeries1"));
    }
